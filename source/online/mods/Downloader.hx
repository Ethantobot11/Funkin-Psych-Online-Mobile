...
class Downloader {
	...
	static var downloadDir:String = #if mobile StorageUtil.getStorageDirectory() + "downloads/" #else openfl.filesystem.File.applicationDirectory.nativePath + "/downloads/" #end;
